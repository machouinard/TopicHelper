...
class EditTopicViewController: UIViewController, UITextFieldDelegate, UITextViewDelegate {
  ...
  func setPreviousControllerCurrentTopic() {
    ...
    let navCon = self.parent as! UINavigationController
    if let tvc = navCon.getPreviousViewController() as? TopicViewController {
  ...
  @objc func keyboardWillShow(notification: NSNotification) {
    guard let keyboardFrame: CGRect = (notification.userInfo?[UIResponder.keyboardFrameEndUserInfoKey]
